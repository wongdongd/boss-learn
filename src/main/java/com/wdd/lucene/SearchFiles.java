...
public class SearchFiles {
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        CollectionStatistics path = searcher.collectionStatistics("path");
        long l = path.docCount();
        System.out.println("文档数量:"+l);
        long l1 = path.sumTotalTermFreq();
        System.out.println("term freq:"+l1);
